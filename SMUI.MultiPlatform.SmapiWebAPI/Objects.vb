Public Class Objects
    ...
    Public Shared Sub Initialize_SmapiRequestInputData(ByRef data As SmapiRequestInputData)
        ...
        data.mods_id = Array.Empty(Of String)()
        data.mods_updatekeys = Array.Empty(Of UpdatekeysData)()
        data.installedversion = Array.Empty(Of String)()
        data.isBroken = Array.Empty(Of String)()
    End Sub

    Public Shared Sub Initialize_UpdatekeysData(ByRef data As UpdatekeysData)
        data.Nexus = Array.Empty(Of String)()
        data.Moddrop = Array.Empty(Of String)()
        data.Github = Array.Empty(Of String)()
        data.CurseForge = Array.Empty(Of String)()
        data.Chucklefish = Array.Empty(Of String)()
    End Sub

    Public Shared Sub Initialize_SmapiResponseOutputData(ByRef data As SmapiResponseOutputData)
        data.id = Array.Empty(Of String)()
        data.suggestedUpdate_version = Array.Empty(Of String)()
        data.suggestedUpdate_url = Array.Empty(Of String)()
        data.metadata = Array.Empty(Of Metadata)()
        data.errors = Array.Empty(Of String)()
    End Sub
