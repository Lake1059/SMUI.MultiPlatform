...
Public Class SearchItem
    ...
    ''' Item full path!
    ''' </summary> 
    Public Results As String() = Array.Empty(Of String)()
                    ...
                    Select Case yourSearchType
                        Case SearchType.ItemName
                            If DetermineWhetherToAddToOutput(mDir2.Name, SearchWhat) = True Then
                                ...
                                Results(Results.Length - 1) = mDir2.FullName
                            End If
                        Case SearchType.NameKey
                            Dim ManifestFile As New SearchFile
                            ManifestFile.SearchManifests(mDir2.FullName)
                            For i = 0 To ManifestFile.FileCollection.Length - 1
                                Dim a As String = FileIO.FileSystem.ReadAllText(FileIO.FileSystem.CombinePath(mDir2.FullName, ManifestFile.FileCollection(i)))
                        ...
                        Case SearchType.ContentPakForAndDependencies
                            ...
                            a.ReadItemInfo(mDir2.FullName, New Objects.ItemCalculateType With {.ContentPackFor = True, .Dependencies = True})
                            For i = 0 To a.ContentPackFor.Length - 1
                                ...
                                End If
                            Next
                            For i = 0 To a.Dependencies.Length - 1
...
jx1:
                        ...
                        Case SearchType.NexusID
                            Dim a As New ItemInfoReader
                            a.ReadItemInfo(mDir2.FullName, New Objects.ItemCalculateType With {.UpdateKeys = True})
                            For i = 0 To a.NexusID.Length - 1
